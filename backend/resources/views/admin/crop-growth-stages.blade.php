...
<head>
    ...
    <title>Aswenna - Crop Growth Stages</title>
...
<body class="min-h-screen bg-[#F8FAFC] text-slate-800 antialiased selection:bg-emerald-500/30">
    ...
    <div class="flex w-full min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0 min-h-screen">
            ...
            <main class="flex-1 p-4 sm:p-6 md:p-8 overflow-y-auto w-full max-w-[1700px] mx-auto">
                <livewire:admin.crop-growth-stages-table />
            </main>
    ...
    <script>
        ...
        document.addEventListener('livewire:init', () => {
            Livewire.on('stage-saved', (event) => {
                Swal.fire({
                    icon: 'success',
                    title: 'Saved',
                    text: event.message || 'Crop growth stage updated.',
                    timer: 1800,
            ...
            window.addEventListener('confirm-stage-delete', (event) => {
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Remove growth stage?',
                    text: `This permanently removes ${event.detail.stageName || 'this stage'} from the database.`,
                    ...
                    if (result.isConfirmed && component) {
                        component.call('deleteStage', event.detail.stageId);
                    }
                });
            });
        });
