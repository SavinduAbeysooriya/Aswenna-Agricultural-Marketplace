...
<head>
    ...
    <title>Aswenna - Crop Rates Oversight</title>
...
<body class="min-h-screen bg-[#F8FAFC] text-slate-800 antialiased selection:bg-emerald-500/30">
    ...
    <div class="flex w-full min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0 min-h-screen">
            ...
            <main class="flex-1 p-4 sm:p-6 md:p-8 overflow-y-auto w-full max-w-[1700px] mx-auto">
                <livewire:admin.crop-rates-table />
            </main>
    ...
    <script>
        ...
        document.addEventListener('livewire:init', () => {
            Livewire.on('rate-saved', (event) => {
                const message = (event && event[0] && event[0].message) || (event && event.message) || 'Action completed successfully.';
                Swal.fire({
                    icon: 'success',
                    title: 'Saved',
                    text: message,
            ...
            window.addEventListener('confirm-rate-delete', (event) => {
                ...
                Swal.fire({
                    ...
                    text: `This permanently deletes this buyer's crop rate submission. Averages will be re-evaluated.`,
                    ...
                    if (result.isConfirmed && component) {
                        component.call('deleteRate', event.detail.rateId);
                    }
                });
            });
        });
